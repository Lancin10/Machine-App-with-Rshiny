#setwd("dir" = "C:\\Users\\Zahira\\Web_scraping\\ML_Appli")
library(shiny)
...
library(packrat)
#library("devtools")
#install_github("smutchler/micad/mica")
#install.packages("micad", dependencies = TRUE)
#devtools::install_github("smutchler/micad/micad")

ui <- fluidPage(
  
  navbarPage(title = "Machine Learning APP",
             tabPanel("Home",
                      jumbotron("Hello Welcome to Machine Learning APP", paste("This is web application for Machine Learning and Artificial Intelligence !"), buttonLabel = "Click Me ! " )
...
#    
 ...
 # )
  ...
  output$text1 <- renderText({
    str1 <- paste("M. Lass Ch?rif") 
    str2 <- paste("lasscherif@yahoo.fr") 
    str3 <- paste("0606060606")
...
#rsconnect::setAccountInfo(name='lasso1',
#                          token='BD20D45B7135FE54F25A6536ADB6C05B',
 #                         secret='/40hM3kLeyc3CabAB6dwVbGPuBaXn6VgtdPIpouc')

#rsconnect::deployApp("C:/Users/Zahira/Web_scraping/ML_Appli")
